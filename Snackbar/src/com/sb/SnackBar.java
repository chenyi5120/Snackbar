...
public class SnackBar {
	 ...
	 *            提示信息
	 * @param duration
	 *            时长{@link}LONG_SNACK = 5000 MED_SNACK = 3500 SHORT_SNACK = 2000
	 *            PERMANENT_SNACK = 0
	 * @return Builder
	 * @author CHEN
	 */
	public static Builder makeMsg(Activity activity, String message, short duration) {
		return new SnackBar.Builder(activity).withMessage(message).withDuration(duration);
	 ...
	 * @author CHEN
	 */
	public static Builder makeMsg(Activity activity, String msg, String actionMsg, short duration) {
		Builder builder = new SnackBar.Builder(activity).withMessage(msg).withActionMessage(actionMsg)
	 ...
	 *            处理事件SnackBar.OnMessageClickListener
	 * @param duration
	 *            时长{@link}LONG_SNACK = 5000 MED_SNACK = 3500 SHORT_SNACK = 2000
	 *            PERMANENT_SNACK = 0
	 * @return Builder
	 */
	public static Builder makeMsg(Activity activity, String msg, String actionMsg,
			OnMessageClickListener onClickListener, short duration) {
		Builder builder = new SnackBar.Builder(activity).withMessage(msg).withActionMessage(actionMsg)
				.withOnClickListener(onClickListener).withDuration(duration);
	...
	public static class Builder {
		 ...
		 * @return
		 */
		public Builder withInputMed(EditText editText, boolean bool) {
			if (bool) {
				close(editText);
			}
			return this;
		...
		public SnackBar show() {
			Snack message = new Snack(mMessage, (mActionMessage != null ? mActionMessage.toUpperCase() : null),
